...
router.post("/", authorize("admin.utilizatori.creare"), validate(createUserSchema), UserController.create);
router.patch("/:id", authorize("admin.utilizatori.editeaza"), UserController.update);
router.delete("/:id", authorize("admin.utilizatori.sterge"), UserController.delete);
router.post("/sync/roles/:id", authorize("admin.utilizatori.editeaza"), UserController.syncRoles);
